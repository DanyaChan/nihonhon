 ...
 * токенизатором kuromoji (локальный словарь IPAdic из lib/dict/
 * грузится при первом наведении), и над словом появляется чтение —
 * обычным тегом <ruby>, как у встроенной фуриганы. При уходе
 * курсора слово разворачивается обратно в текст.
 * ============================================================ */
